...
<html lang="en">
    ...
    <head>
        ...
        <title>Edit User</title> <!-- {{{ REMBEMBER CHANGE THE TITLE }}} -->
        <style type="text/css">
        /* {{{ CSS CODE GOES HERE }}} */
            ...
            <form action="/user/update/<?php echo $user['id']; ?>" method="POST">
                ...
                <div class="row">
                    <div class="six columns">
                        ...
                        <input type="text" name="name" class="u-full-width" value="<?php echo $user['name']; ?>" required>
                    </div>
                    <div class="six columns">
                        <label for="username">Username:</label>
                        <input type="text" name="username" class="u-full-width" value="<?php echo $user['username']; ?>" required>
                    </div>
                </div>
